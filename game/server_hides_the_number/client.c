...
//run with gcc -Wall -o client client.c
//программа на основе примера клиента TCP из учебника
...
int main(int argc, char **argv)
{
    ...
    //пока сервер не скажет клиенту, что он успешно угадал число, клиент гадает
    while(strcmp(recvline, "It is a success!\n") != 0) { 
